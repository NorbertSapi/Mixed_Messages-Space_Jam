...
`;
    ...
    function getImage(character, image) {
        if(character === "Bugs Bunny") {
            image = document.getElementById( "img0" ).style.display = "inline";
        }
        else if(character === "Daffy Duck") {
            imagedocument.getElementById( "img1" ).style.display = "inline";
        }
    ...
    image1 = getImage(characterFirst);
